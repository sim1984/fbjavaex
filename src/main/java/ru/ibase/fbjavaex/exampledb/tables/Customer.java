...
public class Customer extends TableImpl<CustomerRecord> {
    ...
    private static final long serialVersionUID = -2057838295;
     ...
     */
    public final TableField<CustomerRecord, String> NAME = createField("NAME", org.jooq.impl.SQLDataType.VARCHAR(60).nullable(false), this, "");

    /**
     * The column <code>CUSTOMER.ADDRESS</code>.
     */
    public final TableField<CustomerRecord, String> ADDRESS = createField("ADDRESS", org.jooq.impl.SQLDataType.VARCHAR(250), this, "");

    /**
     * The column <code>CUSTOMER.ZIPCODE</code>.
     */
    public final TableField<CustomerRecord, String> ZIPCODE = createField("ZIPCODE", org.jooq.impl.SQLDataType.CHAR(10), this, "");

    /**
     * The column <code>CUSTOMER.PHONE</code>.
     */
    public final TableField<CustomerRecord, String> PHONE = createField("PHONE", org.jooq.impl.SQLDataType.VARCHAR(14), this, "");
