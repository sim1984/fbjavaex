...
public class Webuser extends TableImpl<WebuserRecord> {
    ...
    private static final long serialVersionUID = -1454634621;
     ...
     */
    public final TableField<WebuserRecord, String> EMAIL = createField("EMAIL", org.jooq.impl.SQLDataType.VARCHAR(63).nullable(false), this, "");

    /**
     * The column <code>WEBUSER.PASSWD</code>.
     */
    public final TableField<WebuserRecord, String> PASSWD = createField("PASSWD", org.jooq.impl.SQLDataType.VARCHAR(63).nullable(false), this, "");

    /**
     * Create a <code>WEBUSER</code> table reference
     */
    public Webuser() {
        this(DSL.name("WEBUSER"), null);
    }
    ...
    private Webuser(Name alias, Table<WebuserRecord> aliased, Field<?>[] parameters) {
